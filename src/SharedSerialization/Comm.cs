...
namespace SharedSerialization
{
    ...
    public class Job
    {
        ...
        public UInt64 k2;
        public UInt64 k3;
        public string pre_pow = "";
        ...
        public Job Next()
        {
            Job next = new Job() { difficulty = difficulty, height = height, jobID = jobID, pre_pow = pre_pow, timestamp = timestamp, graphAttempts = graphAttempts };
            next.MutateJob();
            return next;
        }
    }
